...
請以繁體中文撰寫以下格式的【美股收盤日報】：

# 美股收盤日報 {{TODAY_DATE}} {{TODAY_WEEKDAY}}

## 1. 今日一句話總結
（一句話精準總結今日美股格局，含最關鍵驅動因子與市場含義）
...
- 供需動態最新解讀：
- CoWoS / 先進封裝訂單動態：
- 超大規模資本支出（Hyperscaler Capex）趨勢：
- 電力瓶頸與解決進度：

---

## 15. 軟體與 SaaS
- 雲端基礎設施（MSFT Azure / AMZN AWS / GOOGL GCP）：
- 企業軟體（CRM / NOW / WDAY）：
- 網絡安全（PANW / CRWD / ZS）：
- **AI 滲透率驅動 vs 估值壓力：**
...
## 17. ETF 資金流
（搜尋 SPY、QQQ、SOXX、SMH、XLK 等主要 ETF 資金流數據）
- SPY 流入/流出：
- QQQ 流入/流出：
- SOXX / SMH 流入/流出：
- XLK 流入/流出：
...
- VIX 水位與 term structure：
- Put/Call Ratio：
- 大型科技股 options flow（NVDA/AAPL/TSLA 等）：
- GEX（Gamma Exposure）方向：
- **Options 暗示的後市偏向：**
