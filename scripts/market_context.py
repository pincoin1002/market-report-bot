...
def build_market_context(snapshot: Snapshot, report_type: str,
    ...
    return MarketContext(
        ...
        missing_portfolio_items=snapshot.missing_portfolio_items,
        missing_core_market_items=snapshot.missing_core_market_items,
        missing_optional_context_items=snapshot.missing_optional_context_items,
